...
- (NSURL *)applicationDocumentsDirectory {
    ...
    return [appSupportURL URLByAppendingPathComponent:@"nein.werbetafel"];
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"werbetafel" withExtension:@"momd"];
